...
statNA<-paste0('N/A |',length(which(is.na(value2))),'|',NaSubFreq,'% |',NaTotFreq,'%')
cat(paste0(statNA,'\n'))
...
statTotalmissing<-paste0('Total |',length(which(is.na(value))),'|',TotSubMissingFreq,'% |',TotTotMissingFreq,'%')
cat(paste0(statTotalmissing,'\n'))
